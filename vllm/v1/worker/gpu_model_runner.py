...
class GPUModelRunner(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def __init__(
        ...
        # print("self.attention_chunk_size", self.attention_chunk_size)
        ...
        # print("self.compilation_config.cudagraph_capture_sizes", self.compilation_config.cudagraph_capture_sizes)
    ...
    def execute_model(
        ...
        # sampling_metadata = self.input_batch.sampling_metadata
        # print("sampling_metadata is", sampling_metadata) 
        # Run the model.
    ...
    def _dummy_run(
        ...
        # for GQA/MQA.
        print("Using dummy run in gpu_model_runner.py")
