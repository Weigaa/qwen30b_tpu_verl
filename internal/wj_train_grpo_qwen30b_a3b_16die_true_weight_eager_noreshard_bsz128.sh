...
python3 -m verl.trainer.main_ppo --config-path="${CONFIG_DIR}" \
    ...
    +actor_rollout_ref.actor.megatron.override_transformer_config.swap_optimizer=True  $@ >> wjeagerqwen30b-a3b-eager_linear_bsz64x16_new.txt