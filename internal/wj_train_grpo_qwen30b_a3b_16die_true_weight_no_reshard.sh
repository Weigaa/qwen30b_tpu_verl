...
python3 -m verl.trainer.main_ppo --config-path="${CONFIG_DIR}" \
    ...
    +actor_rollout_ref.actor.megatron.override_transformer_config.swap_optimizer=True  $@ >> wjqwen30b-a3b-record_graph_baseline_bsz128x16384_profiler_no_reshard.txt 