...
export VERL_SIDECAR_REPLICA_COUNT=${VERL_SIDECAR_REPLICA_COUNT:-8}
...
export VERL_SIDECAR_MAX_NUM_SEQS=16
export VERL_SIDECAR_GENERATE_CHUNK_SIZE=32
export VERL_SIDECAR_MAX_PROMPTS_PER_REPLICA=32
...
if (( VERL_SIDECAR_MAX_MODEL_LEN < sidecar_min_model_len )); then
    ...
    export VERL_SIDECAR_MAX_MODEL_LEN=${sidecar_min_model_len}
fi
if (( VERL_SIDECAR_MAX_NUM_BATCHED_TOKENS < VERL_SIDECAR_MAX_MODEL_LEN )); then
