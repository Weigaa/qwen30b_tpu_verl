...
def _materialize_rollout_weight_staging(
    ...
    Align with `origin/nm_mode1_final`: cloning into rollout-owned staging
    tensors avoids keeping caller-owned tensors/aliases alive through the
    loader path longer than intended during mode=1 weight reload.
    """
