...
class InprocClient(EngineCoreClient):
    ...
    def get_output(self) -> EngineCoreOutputs:
        if getattr(self.engine_core, "use_dp_inproc", False) and getattr(
            self.engine_core, "async_scheduling", False
        ):
            outputs, model_executed = self.engine_core.step_with_dp()
        else:
    ...
    def dp_engines_running(self) -> bool:
        return self.engine_core.engines_running
