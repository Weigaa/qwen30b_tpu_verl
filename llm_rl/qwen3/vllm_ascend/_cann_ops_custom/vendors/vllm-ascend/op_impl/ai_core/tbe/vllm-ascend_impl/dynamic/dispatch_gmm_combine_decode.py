...
def get_dtype_fmt_options(__inputs__, __outputs__):
    ...
    output_names = ['output', 'expert_token_nums']
...
def _build_args(x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__, x_active_mask_in__, output_out_, expert_token_nums_out_, group_ep, ep_rank_size, ep_rank_id, moe_expert_num, share_expert_num, share_expert_rank_num, quant_mode, global_bs):
    __inputs__ = []
    for arg in [x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__, x_active_mask_in__]:
        if arg != None:
            ...
            __inputs__.append(arg)
    __outputs__ = []
    for arg in [output_out_, expert_token_nums_out_]:
        if arg != None:
            if isinstance(arg, (list, tuple)):
                if len(arg) == 0:
                    continue
...
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def dispatch_gmm_combine_decode(x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__=None, x_active_mask_in__=None, output_out_=None, expert_token_nums_out_=None, group_ep="", ep_rank_size=0, ep_rank_id=0, moe_expert_num=0, share_expert_num=0, share_expert_rank_num=0, quant_mode=0, global_bs=0, kernel_name="dispatch_gmm_combine_decode", impl_mode = ""):
    ...
    custom_compile_options = {'__ALLSOC__': ['--cce-auto-sync=off', '-Wno-deprecated-declarations', '-Werror', '-I/workspace/vllm-ascend/csrc/third_party/catlass/include']},
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__ , impl_mode = impl_mode, origin_inputs=[x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__, x_active_mask_in__], origin_outputs = [output_out_, expert_token_nums_out_],\
                param_type_dynamic = True, mc2_ctx = ["mc2_context_0"], param_type_list = ['required', 'required', 'dynamic', 'dynamic', 'dynamic', 'dynamic', 'required', 'optional', 'optional', 'required', 'required'], init_value_list = [None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}', {'valueDepend': {}})

def op_select_format(x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__=None, x_active_mask_in__=None, output_out_=None, expert_token_nums_out_=None, group_ep="", ep_rank_size=0, ep_rank_id=0, moe_expert_num=0, share_expert_num=0, share_expert_rank_num=0, quant_mode=0, global_bs=0, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, expert_ids_in__, gmm1_permuted_weight_in__, gmm1_permuted_weight_scale_in__, gmm2_weight_in__, gmm2_weight_scale_in__, expert_scales_in__, expert_smooth_scales_in__, x_active_mask_in__, output_out_, expert_token_nums_out_, group_ep, ep_rank_size, ep_rank_id, moe_expert_num, share_expert_num, share_expert_rank_num, quant_mode, global_bs)
