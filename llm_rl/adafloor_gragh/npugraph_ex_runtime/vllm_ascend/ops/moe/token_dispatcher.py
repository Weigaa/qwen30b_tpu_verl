...
class TokenDispatcherWithAllGather(MoETokenDispatcher):
    ...
    def token_dispatch(self,
        ...
        # GraphEX can preserve the FX dtype as int64 while forwarding the
        # routing kernel's backing storage with the wrong runtime dtype at the
        # 128-expert Qwen3 shape. An explicit NPU cast materializes the tensor
        # and keeps grouped matmul on its required int64 group-list contract.
