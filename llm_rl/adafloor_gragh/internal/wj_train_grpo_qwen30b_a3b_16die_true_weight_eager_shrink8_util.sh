...
# Shrink-to-8 redundant expert mode: no sidecar. Emits lightweight decode-step
...
export VLLM_ASCEND_NPU_UTIL_CSV=${VLLM_ASCEND_NPU_UTIL_CSV:-"${WJ_RECORDS_DIR}/npu_util/${run_id}_shrink8.csv"}
