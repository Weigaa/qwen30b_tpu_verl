...
class AscendFusedMoE(CustomAscendFusedMoE):
    ...
    def update_expert_map(self, new_expert_map):
        super().update_expert_map(new_expert_map)
    ...
    def _load_w13(self,
        ...
        logical_expert_data = (
            expert_data[0]
            if expert_data.ndim == loaded_weight.ndim + 1
            and int(expert_data.shape[0]) == 1 else expert_data)
        loaded_weight, shard_dim = self.transpose_weight(
            loaded_weight, logical_expert_data, shard_dim)
...
class AscendSharedFusedMoE(SharedFusedMoE, AscendFusedMoE):
    ...
    def forward_impl(self, hidden_states: torch.Tensor,
        ...
        fused_output = AscendFusedMoE.forward(
            self,
