...
class Scheduler(SchedulerInterface):
    ...
    def __init__(
        ...
        print("max_num_running_reqs:", self.max_num_running_reqs,
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            #check what request include
            # print("request include: ", request)
            ...
            #print("num_new_tokens before encoder sched =", num_new_tokens)
            ...
            while True:
                ...
                if new_blocks is None:
                    ...
                    logger.info(
                        "Preempting request %s for request %s "
                        "discarded_computed_tokens=%d",
        ...
        #print("[sched] scheduled_running_reqs =", len(scheduled_running_reqs))
        ...
        #print("[sched] total_num_scheduled_tokens =",sum(num_scheduled_tokens.values()))
