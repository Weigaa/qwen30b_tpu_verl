...
class RolloutConfig(BaseConfig):
    ...
    # Keep PIECEWISE as the compatibility default when capture sizes are set.
    # FULL_DECODE_ONLY is opt-in until the native NPU full-decode path has
    # passed model-specific KV-write parity validation.
    ...
    shrink_aware: dict = field(default_factory=dict)
