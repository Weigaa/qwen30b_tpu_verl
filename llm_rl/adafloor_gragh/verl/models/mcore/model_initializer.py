...
class DeepseekV2Model(BaseModelInitializer):
    """Initializer for DeepSeek MLA MoE models, including V2 and V3."""
    ...
    def initialize(
        ...
        **kwargs,
        ...
        # MTP
        mtp_num_layers = getattr(self.tfconfig, "mtp_num_layers", None)
...
# Keep the established name for callers outside the model registry.
DeepseekV3Model = DeepseekV2Model
